    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            ...
            <form action="{{ route('employees.store') }}" method="POST" id="registration-form">
                @csrf
                <h3>Let us know if you come!</h3>
                <div class="inputBox">
                    <span class="fas fa-user"></span>
                    <input class=" @error('name') is-invalid @enderror" value="{{ old('name') }}" id="name"
                ...
                <div class="inputBox">
                    ...
                    <input class="form-control @error('nohp') is-invalid @enderror " value="{{ old('nohp') }}"
                        id="nohp" name="nohp" type="number" placeholder="number">
                </div>
                @error('nohp')
                    <div class="text-danger"><small>{{ $message }}</small></div>
                @enderror
                <input type="submit" value="send" class="btn btn-secondary rounded-pill py-2 px-4">
            </form>
