                ...
                <div class="card">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="card-group m-auto">
                            @foreach ($carts as $cart)
                                <div class="card m-2" style="width: 14rem;">
                                    <div class="mt-2 mb-4">
                                        <img src="{{ asset('uploads/products/' . $cart->product->foto) }}" height="80px"
                                            width="80px" alt="">
                                        </div>
                                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column justify-content-end align-items-end">
                            ...
                            <div class="d-flex">
                                <a href="/show-products"><button class="btn btn-primary me-4"
                                    type="button">Back</button></a>
                          
                            <form action="{{ route('checkout') }}" method="post">

                                {{ csrf_field() }}
                                <input id="total_harga" type="hidden" class="form-control" name="total_harga" required value="2">
                                ...
                                <div class="card m-2" style="width: 14rem;" data-wow-delay="0.1s">
                                    <div class="product-item">
                                        ...
                                        <div class="text-center p-4">
                                            ...
                                            <h4>{{ $cart->jumlah }} x {{ $cart->product->harga }}</h4>
